...
console.log(`[FRONTEND SCRAPE] triggerBackendScrape called with payload:`, payload);
const encrypted = encryptData(payload);
console.log(`[FRONTEND SCRAPE] Encrypted payload sent to /api/scrape-stream (length: ${encrypted.length})`);
...
console.error("[FRONTEND SCRAPE ERROR] triggerBackendScrape failed:", err.message, err.stack || '');
...
console.log(`[FRONTEND SUBS] fetchSubtitles called with payload:`, payload);
const encrypted = encryptData(payload);
console.log(`[FRONTEND SUBS] Encrypted payload sent to /api/subs (length: ${encrypted.length})`);
...
console.error("[FRONTEND SUBS ERROR] fetchSubtitles failed:", err.message, err.stack || '');
    }
  };
